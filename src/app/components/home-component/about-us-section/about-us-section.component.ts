    ...
    this.teamMembers = [
      {
        ...
        specialization: this.translationService.translate('about.team.sarah.specialization'),
      ...
      },
      {
        ...
        specialization: this.translationService.translate('about.team.michael.specialization'),
      ...
      },
      {
        ...
        specialization: this.translationService.translate('about.team.emma.specialization'),
      ...
      },
      {
        ...
        specialization: this.translationService.translate('about.team.james.specialization'),
        image: 'https://images.unsplash.com/photo-1582750433449-648ed127bb54?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1974&q=80',
        certifications: ['DPT', 'COMT', 'Cert.MDT'],
      },
    ];
